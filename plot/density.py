...
d1_dense=pd.read_csv('../data/SLy4HPL2/Z82N126L1_SLy4HPL2/density.csv',comment='#')
#print(d1_dense.head)
...
ax.text(3,-0.10,r'SLy4',{'color':'k','fontsize':14})
ax.text(3,-0.14,r'HP$\Lambda$2',{'color':'k','fontsize':14})
ax.text(8,0.05,r'$^{209}_\Lambda$Pb',{'color':'k','fontsize':14})
