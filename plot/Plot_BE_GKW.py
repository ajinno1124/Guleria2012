...
BindingEnergyL("SLy4","GKW2")
BindingEnergyL("SLy4","GKW3")
BindingEnergyL("SLy4","GKW2+MD1")
BindingEnergyL("SLy4","GKW3+MD2")
BindingEnergyL("SLy4","GKW3+MD3")
...
Plot_OnePot("GKW2",'tab:brown',':')
Plot_OnePot("GKW3",'r','-')
#Plot_OnePot("GKW2+MD1",'darkorange','-.')
#Plot_OnePot("GKW3+MD2",'m','--')
#Plot_OnePot("GKW3+MD3",'darkgreen','-')
...
plt.savefig("BElam_GKW.pdf",dpi=300)
plt.savefig("BElam_GKW.png",dpi=300)
plt.show()
