...
d5_mom=pd.read_csv('../../data/Potential/Potential_14/MomentumDep_14.csv')
d6_mom=pd.read_csv('../../data/Potential/Potential_9/MomentumDep_9.csv')
d7_mom=pd.read_csv('../../data/Potential/Potential_12/MomentumDep_12.csv')
...
a1=ax.scatter(xdata,ydata,marker='o',s=20,label='Kohno3', edgecolor="k",facecolor='none')
...
a2=ax.scatter(xdata,ydata,marker='s',s=20,label='Kohno2', color="black")
...
#b1=ax.plot(d12_mom["k"],d12_mom["Um"],label=r"Kohno2 ($k<1.5$/fm) Fit",linewidth=1,color='darkgreen',ls='-')
#b2=ax.plot(d13_mom["k"],d13_mom["Um"],label=r"Kohno3 ($k<1.5$/fm) Fit",linewidth=1.9,color='r',ls='-')
b4=ax.plot(d5_mom["k"],d5_mom["Um"],label=r"HPL2",linewidth=1.5,color='k',ls="-")
b5=ax.plot(d6_mom["k"],d6_mom["Um"],label=r"LY1",linewidth=2,color='k',ls="--")
b6=ax.plot(d7_mom["k"],d7_mom["Um"],label=r"LY4",linewidth=2,color='k',ls=":")
...
leg1=ax.legend(handles=[b4[0],b5[0],b6[0]],loc='lower right',frameon=0,numpoints=1,fontsize=16)
leg2=ax.legend(handles=[a1,a2],loc='upper left',frameon=0,numpoints=1,fontsize=16)
