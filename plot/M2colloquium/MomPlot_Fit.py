...
b1=ax.plot(d12_mom["k"],d12_mom["Um"]-d12_mom["Um"][0],label=r"Kohno2 Fit",linewidth=2.0,color='b',ls=':')
b2=ax.plot(d13_mom["k"],d13_mom["Um"]-d13_mom["Um"][0],label=r"Kohno3 Fit",linewidth=1.9,color='darkgreen',ls='-')
#b4=ax.plot(d5_mom["k"],d5_mom["Um"]-d5_mom["Um"][0],label=r"HPL2",linewidth=1.5,color='k',ls="-")
#b5=ax.plot(d6_mom["k"],d6_mom["Um"]-d6_mom["Um"][0],label=r"LY1",linewidth=2,color='k',ls="--")
#b6=ax.plot(d7_mom["k"],d7_mom["Um"]-d7_mom["Um"][0],label=r"LY4",linewidth=2,color='k',ls=":")
...
leg1=ax.legend(handles=[b1[0],b2[0]],loc='upper left',frameon=0,numpoints=1,fontsize=16)
...
plt.savefig("MomentumDependence_Fit.pdf",dpi=300)
plt.savefig("MomentumDependence_Fit.png",dpi=300)
