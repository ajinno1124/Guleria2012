...
def Plot_OnePot(NParamType,LParamType,label,color,fmt,linewidth):
	...
	#ax.plot(d1["A"]**(-2/3),d1["BE_Int(MeV)"],fmt,c=color,lw=linewidth,ms=5,fillstyle='none')
	#ax.plot(d2["A"]**(-2/3),d2["BE_Int(MeV)"],fmt,c=color,lw=linewidth,ms=5,fillstyle='none')
	#ax.plot(d3["A"]**(-2/3),d3["BE_Int(MeV)"],fmt,c=color,lw=linewidth,ms=5,fillstyle='none')
	#ax.plot(d4["A"]**(-2/3),d4["BE_Int(MeV)"],fmt,c=color,lw=linewidth,ms=5,fillstyle='none')
	#ax.plot(d5["A"]**(-2/3),d5["BE_Int(MeV)"],fmt,c=color,lw=linewidth,ms=5,fillstyle='none')

Plot_OnePot("SLy4","GKW2_medium(rho1.5)_a3tuned",'GKW2','b','o-',1.5)
...
plt.yticks(arange(10,30.1,5), fontsize=14)
...
plt.savefig("Plot_BE_GKW3.pdf",dpi=300)
plt.savefig("Plot_BE_GKW3.png",dpi=300)
plt.show()
