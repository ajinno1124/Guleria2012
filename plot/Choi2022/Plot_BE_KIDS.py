...
BindingEnergyL("SLy4","KIDS0")
BindingEnergyL("SLy4","KIDSA")
BindingEnergyL("SLy4","KIDSB")
BindingEnergyL("SLy4","KIDSC")
BindingEnergyL("SLy4","KIDSD")
...
Plot_OnePot("KIDS0",'b','-',1.5)
Plot_OnePot("KIDSA",'k','-',1.5)
Plot_OnePot("KIDSB",'r','-.',1.5)
Plot_OnePot("KIDSC",'darkgreen','-.',1.5)
Plot_OnePot("KIDSD",'darkorange','-.',1.5)
...
plt.savefig("BElam_KIDS.pdf",dpi=300)
plt.savefig("BElam_KIDS.png",dpi=300)
plt.show()
