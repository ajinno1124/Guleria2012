...
plt.scatter(df_best['L (MeV)'],df_best["K (MeV)"],c=df_best["ChiSquare6"],cmap=plt.cm.jet,s=30,edgecolor='k')
...
plt.savefig("LK_Chi_all_best.pdf",dpi=300)
plt.savefig("LK_Chi_all_best.png",dpi=300)
plt.show()
