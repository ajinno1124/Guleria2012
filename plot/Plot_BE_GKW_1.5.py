...
BindingEnergyL("SLy4","GKW2_1.5")
BindingEnergyL("SLy4","GKW3_1.5")
BindingEnergyL("SLy4","GKW2_1.5+Kohno2")
BindingEnergyL("SLy4","GKW3_1.5+Kohno3")
...
ax.errorbar(df_data["A^(-2/3)"],df_data["exp(MeV)"],yerr=df_data["exp_error(MeV)"],label="exp.",fmt='o',markersize=5,ecolor='k',markeredgecolor = "black",color='k',zorder=10)
...
Plot_OnePot("GKW2_1.5",'tab:brown',':')
Plot_OnePot("GKW3_1.5",'r','-')
Plot_OnePot("GKW2_1.5+Kohno2",'darkorange','-.')
Plot_OnePot("GKW3_1.5+Kohno3",'m','--')
...
plt.savefig("BElam_GKWMD.pdf",dpi=300)
plt.savefig("BElam_GKWMD.png",dpi=300)
plt.show()
