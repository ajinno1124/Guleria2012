...
ax.plot(d1_dense["r(fm)"],d1_dense["Rhol"],label=r"$^{16}_\Lambda$O",linewidth=2,color="k")
ax.plot(d2_dense["r(fm)"],d2_dense["Rhol"],label=r"$^{40}_\Lambda$Ca",linewidth=2,color="red")
ax.plot(d3_dense["r(fm)"],d3_dense["Rhol"],label=r"$^{89}_\Lambda$Y",linewidth=2,color='b')
...
plt.savefig("density_GKWa3.pdf",dpi=300)
plt.savefig("density_GKWa3.png",dpi=300)
plt.show()
