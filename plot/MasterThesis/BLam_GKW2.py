...
Plot_OnePot(ax1,"SLy4","GKW2_medium(rho1.5)+Kohno2(k1.5)_a3tuned",'GKW2+Kohno2','b',':',2)
Plot_OnePot(ax1,"SLy4","GKW3_medium(rho1.5)+Kohno3(k1.5)_a3tuned",'GKW3+Kohno3','darkgreen','-',2)
...
ax1.set_xticks(arange(0.00,0.26,0.05), fontsize=14)
ax1.set_yticks(arange(-10,30.1,5), fontsize=14)
ax1.set_xlabel('$A^{-2/3}$',fontsize=16)
ax1.set_ylabel('$B_\Lambda $ (MeV)',fontsize=16)
Add_Nuclide(ax1)
Add_Orbital(ax1)

plt.savefig("BLam_GKW2.pdf",dpi=300)
plt.savefig("BLam_GKW2.png",dpi=300)
plt.show()
