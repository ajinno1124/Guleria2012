...
b1=ax.plot(d12_mom["k"],d12_mom["Um"]-d12_mom["Um"][0],label=r"Kohno2",linewidth=1,color='darkgreen',ls='-')
...
leg2=ax.legend(handles=[a1,a2,a3[0]],loc='lower right',frameon=0,numpoints=1,fontsize=16)
