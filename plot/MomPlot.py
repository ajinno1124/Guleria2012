...
a1=ax.plot(xdata,ydata,label=r'Kohno3',linewidth=5, color="black")
...
#ax.scatter(xdata,ydata,s=1,label='Kohno3', alpha=1, linewidths=10, color="black")
a2=ax.plot(xdata,ydata,label=r'Kohno2',linewidth=3.5, color="black",ls='--')
...
b4=ax.plot(d6_mom["k"],d6_mom["Um"],label=r"HPL2",linewidth=2,color='tab:cyan',ls=":")
b5=ax.plot(d7_mom["k"],d7_mom["Um"],label=r"LY1",linewidth=2,color='k',ls=":")
