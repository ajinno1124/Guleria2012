...
ax.plot(d1_pot["r(fm)"],d1_pot["Vll(MeV)"],label=r"$^{16}_\Lambda$O",linewidth=2,color="k", ls="-")
ax.plot(d2_pot["r(fm)"],d2_pot["Vll(MeV)"],label=r"$^{40}_\Lambda$Ca",linewidth=2,color="red", ls="-")
ax.plot(d3_pot["r(fm)"],d3_pot["Vll(MeV)"],label=r"$^{89}_\Lambda$Y",linewidth=2,color='b',ls='-')
ax.plot(d4_pot["r(fm)"],d4_pot["Vll(MeV)"],label=r"$^{139}_\Lambda$La",linewidth=2,color='m',ls='-')
ax.plot(d5_pot["r(fm)"],d5_pot["Vll(MeV)"],label=r"$^{208}_\Lambda$Pb",linewidth=2,color='darkgreen',ls='-')
...
plt.savefig("PotentialLam_GKW3.pdf",dpi=300)
plt.savefig("PotentialLam_GKW3.png",dpi=300)
plt.show()
